...
func run() (code int) {
	...
	operators := fs.String("operators", strings.Join(cfg.Operators, ","), "comma-separated operators: boundary,boolean,arithmetic,errorreturn,switch,loop,channel,assignment,relational")
